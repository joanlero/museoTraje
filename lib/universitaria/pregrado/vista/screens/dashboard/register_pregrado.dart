...
class WebMainRegisterPregrado extends StatefulWidget {
  static const String id = "addpregrado";

  @override
  State<WebMainRegisterPregrado> createState() => _WebMainRegisterPregradoState();
}

class _WebMainRegisterPregradoState extends State<WebMainRegisterPregrado> {
  ...
  Widget build(BuildContext context) {
    return AdminScaffold(
      ...
      sideBar: SideBar(
        ...
        selectedRoute: WebMainRegisterPregrado.id,
        onSelected: (item) {
  ...
  save() async {
    if (_formKey.currentState!.validate()) {
      ...
      await uploadImages();
      await PregradoControllerWeb.addPregrado(
        ModelPregradoWeb(
          idPregrado: uuid.v4(),
