...
class WebMainRegisterTecnicas extends StatefulWidget {
  static const String id = "addtecnica";

  @override
  State<WebMainRegisterTecnicas> createState() => _WebMainRegisterTecnicasState();
}

class _WebMainRegisterTecnicasState extends State<WebMainRegisterTecnicas> {
  ...
  Widget build(BuildContext context) {
    return AdminScaffold(
      ...
      sideBar: SideBar(
        ...
        selectedRoute: WebMainRegisterTecnicas.id,
        onSelected: (item) {
  ...
  save() async {
    if (_formKey.currentState!.validate()) {
      ...
      await uploadImages();
      await TecnicasControllerWeb.addTecnica(
        ModelTecnicasWeb(
          idTecnica: uuid.v4(),
