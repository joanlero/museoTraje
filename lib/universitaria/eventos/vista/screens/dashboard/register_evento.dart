...
class WebMainRegisterEventoUniversitaria extends StatefulWidget {
  static const String id = "addcardUniversitaria";

  @override
  State<WebMainRegisterEventoUniversitaria> createState() => _WebMainRegisterEventoUniversitariaState();
}

class _WebMainRegisterEventoUniversitariaState extends State<WebMainRegisterEventoUniversitaria> {
  ...
  Future<void> save() async {
    if (_formKey.currentState!.validate()) {
      ...
      await uploadImages();
      await EventoControllerWeb.addEventoUniversitaria(
        ModelEventoWeb(
          idEvento: uuid.v4(),
