...
class EventoControllerWeb {
  ...
  static Future<void> addEventoUniversitaria(ModelEventoWeb modelEventoWeb) async {
  ...
  static Future<void> updateEventoUniversitaria(String id, ModelEventoWeb modelEventoWeb) async {
  ...
  Future<void> deleteEventoUniversitaria(String id) async {
    final CollectionReference db = FirebaseFirestore.instance.collection("eventos");
    try {
