...
class WebMainRegisterCircular extends StatefulWidget {
  static const String id = "addcircular";

  @override
  State<WebMainRegisterCircular> createState() => _WebMainRegisterCircularState();
}

class _WebMainRegisterCircularState extends State<WebMainRegisterCircular> {
  ...
  Widget build(BuildContext context) {
    return AdminScaffold(
      ...
      sideBar: SideBar(
        ...
        selectedRoute: WebMainRegisterCircular.id,
        onSelected: (item) {
  ...
  save() async {
    if (_formKey.currentState!.validate()) {
      ...
      await uploadImages();
      await CircularesControllerWeb.addCircular(
        ModelCircularWeb(
          idCircular: uuid.v4(),
