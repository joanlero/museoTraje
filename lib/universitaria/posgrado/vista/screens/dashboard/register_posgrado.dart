...
class WebMainRegisterPosgrado extends StatefulWidget {
  static const String id = "addposgrado";

  @override
  State<WebMainRegisterPosgrado> createState() => _WebMainRegisterPosgradoState();
}

class _WebMainRegisterPosgradoState extends State<WebMainRegisterPosgrado> {
  ...
  Widget build(BuildContext context) {
    return AdminScaffold(
      ...
      sideBar: SideBar(
        ...
        selectedRoute: WebMainRegisterPosgrado.id,
        onSelected: (item) {
                        ...
                        children: [
                          Expanded(
                            child: TextFormField(
                              ...
                              maxLength: 5000,
                              decoration: InputDecoration(
                                hintText: 'Descripción Larga del Posgrado',
                                border: OutlineInputBorder(
                                  borderSide: BorderSide(color: Colors.black),
                                ),
                                enabledBorder: OutlineInputBorder(
  ...
  save() async {
    if (_formKey.currentState!.validate()) {
      ...
      await uploadImages();
      await PosgradoControllerWeb.addPosgrado(
        ModelPosgradoWeb(
          idPosgrado: uuid.v4(),
