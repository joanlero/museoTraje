...
import 'package:adminmuseo/museoTraje/eventos/vista/screens/dashboard/register_evento_museo.dart';
import 'package:adminmuseo/museoTraje/eventos/vista/screens/dashboard/update_evento_museo.dart';
                      ...
                      return AlertDialog(
                        ...
                        actions: <Widget>[
                          ...
                          TextButton(
                            child: Text('Eliminar'),
                            onPressed: () async {
                              await _eventoController.deleteEventoMuseo(evento.id);
                              Navigator.of(context).pop();
